package com.techtorque.appointment_service.config; // Change package for each service
...
public class DatabasePreflightInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
  ...
  public void initialize(@NonNull ConfigurableApplicationContext applicationContext) {
    ...
    try (Connection connection = DriverManager.getConnection(jdbcUrl, username, password)) {
      ...
      // Instead of throwing an exception, we take control and exit forcefully.
      // This prevents Spring Boot from printing its own stack trace.
      System.exit(1);
    }
  }
}